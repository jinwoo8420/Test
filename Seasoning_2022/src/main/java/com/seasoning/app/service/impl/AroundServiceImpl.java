...
public class AroundServiceImpl implements AroundService {
	...
	public List<AroundVO> getDeaguAround() throws IOException {
		...
		try {
			url += ("?" + URLEncoder.encode("serviceKey", "UTF-8")
					+ "=gYKS7rrYVhnUEp3XTlvwEoDEMXL5foa3kM5B%2Fr0zeetiGTYyg4ZERj%2BiR6rPlEZji5q%2FeIlnRmkMTJT6XHn9Ow%3D%3D");
...
//        log.debug(item.toString(4));
		...
		Gson gson = new Gson();
		List<AroundVO> list = gson.fromJson(item.toString(), new TypeToken<List<AroundVO>>() {
		}.getType());
