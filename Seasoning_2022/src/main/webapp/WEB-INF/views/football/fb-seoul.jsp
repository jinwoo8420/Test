...
<body>
	...
	<section id="fb_section">
		...
		<link rel="stylesheet" href="${rootPath}/static/css/area-view.css?ver20220616001" />
		<script>
	...
	<div class="area-view">
		<div class="area-container">
			<div class="area-menu">
				...
				<button class="area-btn gwangju_btn" type="button">광주</button>
				<button class="area-btn busan_btn" type="button">부산</button>
				<button class="area-btn ulsan_btn" type="button">울산</button>
				<button class="area-btn sejong_btn" type="button">세종</button>
				<button class="area-btn gyeonggi_btn" type="button">경기</button>
				<button class="area-btn gangwon_btn" type="button">강원</button>
				<button class="area-btn chungbuk_btn" type="button">충북</button>
				<button class="area-btn chungnam_btn" type="button">충남</button>
				<button class="area-btn gyeongbuk_btn" type="button">경북</button>
				<button class="area-btn gyeongnam_btn" type="button">경남</button>
				<button class="area-btn jeonbuk_btn" type="button">전북</button>
				<button class="area-btn jeonnam_btn" type="button">전남</button>
				<button class="area-btn jeju_btn" type="button">제주</button>
			</div>
		</div>
	</div>
