							...
							<div class="slide">
								<c:forEach items="${TOURS}" var="TOUR">
									<div class="attr-container">
										<a href="${rootPath}/detail/fooddetail/${TOUR.contentid}" style="color: black">
						...
						<div class="slides">
							<div class="slide">
								<c:forEach items="${FOODS}" var="FOOD">
									<div class="attr-container">
										<a href="${rootPath}/detail/fooddetail/${FOOD.contentid}" style="color: black">
						...
						<div class="slides">
							<div class="slide">
								<c:forEach items="${LODGMENTS}" var="LODGMENT">
									<div class="attr-container">
										<a href="${rootPath}/detail/fooddetail/${LODGMENT.contentid}" style="color: black">
